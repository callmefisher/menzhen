      ...
      <html>
        <head>
          ...
          <style>
            ...
            .prescription-print { max-width: 600px; margin: 0 auto; }
            ...
            .prescription-print .herb-list { list-style: none; padding: 0; }
            ...
            .prescription-print .herb-dosage { width: 80px; text-align: right; }
            .prescription-print .herb-notes { width: 120px; text-align: right; color: #666; }
        ...
        <div ref={printRef}>
          <div className="prescription-print">
            ...
            <div className="footer">
              ...
              {prescription.notes && (
                <div className="row">
                  <span>医嘱：{prescription.notes}</span>
                </div>
              )}
            </div>
