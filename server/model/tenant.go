...
type Tenant struct {
	...
	AppointmentMaxPerSlot     *int  `gorm:"column:appointment_max_per_slot;default:1" json:"appointment_max_per_slot"`
	AppointmentAdvanceDays    *int  `gorm:"column:appointment_advance_days;default:30" json:"appointment_advance_days"`
